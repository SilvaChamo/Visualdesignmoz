...
import { Globe, Mail, ShieldCheck, DatabaseBackup, RefreshCw, AppWindow, Server, LifeBuoy } from 'lucide-react'
        ...
        >
          <div className="container mx-auto max-w-7xl px-4 sm:px-6">
            <div className="text-center flex flex-col items-center max-w-4xl mx-auto px-4 md:px-[100px] mb-0">
              ...
              <p className="text-sm text-black/60 dark:text-zinc-400 mx-auto mb-8 sm:mb-10">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-8">
              {[
                ...
                <div key={titleKey} className="flex flex-col items-center text-center">
                  <div className="w-14 h-14 rounded-xl bg-red-50 dark:bg-red-500/10 flex items-center justify-center mb-3">
                    <Icon className="w-7 h-7 text-red-600 dark:text-red-500" />
                  </div>
