  ...
  const sections: SectionData[] = [
    {
      ...
      items: [
        { id: 'email-accounts', label: 'Email Accounts', icon: 'email-accounts', onClick: () => router.push('/dashboard?page=emails-new') },
        { id: 'email-forwarding', label: 'Forwarding', icon: 'email-forwarding', onClick: () => router.push('/dashboard?page=cp-email-forwarding') },
        { id: 'email-deliverability', label: 'Deliverability', icon: 'email-deliverability', onClick: () => router.push('/dashboard?page=cp-email-dkim') },
        { id: 'mailing-lists', label: 'Mailing Lists', icon: 'mailing-lists', onClick: () => router.push('/dashboard/mensagens?tab=subscritores') },
        { id: 'mx-entry', label: 'MX Entry', icon: 'mx-entry', onClick: () => router.push(`/dashboard?page=dns-central&domain=${domain}`) },
      ]
    },
    {
      id: 'files',
      ...
      items: [
        { id: 'file-manager', label: 'File Manager', icon: 'file-manager', onClick: () => router.push(`/dashboard?page=file-manager&domain=${domain}`) },
        { id: 'ftp-accounts', label: 'FTP Accounts', icon: 'ftp-accounts', onClick: () => router.push('/dashboard?page=cp-ftp') },
        { id: 'disk-usage', label: 'Disk Usage', icon: 'disk-usage', onClick: () => router.push(`/dashboard?page=file-manager&domain=${domain}`) },
        { id: 'git-version', label: 'Git Version Control', icon: 'git-version', onClick: () => router.push('/dashboard?page=git-deploy') },
        { id: 'backups', label: 'Backups', icon: 'backups', onClick: () => router.push('/dashboard?page=backup-manager') },
      ]
    },
    {
      id: 'databases',
    ...
    },
    {
      ...
      borderColor: 'border-blue-200',
      items: [
        { id: 'addon-domains', label: 'Addon Domains', icon: 'addon-domains', onClick: () => router.push('/dashboard?page=domains-new') },
        { id: 'dns-zone', label: 'DNS Zone Editor', icon: 'dns-zone', onClick: () => router.push(`/dashboard?page=dns-central&domain=${domain}`) },
        { id: 'domain-alias', label: 'Domain Aliases', icon: 'domain-alias', onClick: () => router.push('/dashboard?page=cp-list-subdomains') },
        { id: 'domain-redirects', label: 'Redirects', icon: 'domain-redirects', onClick: () => router.push('/dashboard?page=cp-list-subdomains') },
      ]
    },
    {
      id: 'security-section',
      ...
      items: [
        { id: 'ssl-tls', label: 'SSL / TLS', icon: 'ssl-tls', onClick: () => router.push('/dashboard?page=cp-ssl') },
        { id: 'ip-blocker', label: 'IP Blocker', icon: 'ip-blocker', onClick: () => router.push('/dashboard?page=cp-security') },
        { id: 'mod-security', label: 'ModSecurity', icon: 'mod-security', onClick: () => router.push('/dashboard?page=cp-security') },
      ]
    },
    {
      id: 'metrics-section',
    ...
    },
    {
      ...
      items: [
        { id: 'app-wordpress', label: 'WordPress', icon: 'wordpress', onClick: () => router.push('/dashboard?page=wordpress-install'), badge: '1-CLICK' },
        { id: 'applications', label: 'Applications', icon: 'applications', onClick: () => router.push('/dashboard?page=wordpress-install') },
      ]
    },
  ]
        ...
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              <Link
                href="/dashboard?page=domains-list"
