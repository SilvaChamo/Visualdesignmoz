        ...
        <div className="relative overflow-hidden pt-[180px] pb-[100px]">
          ...
          <div className="container mx-auto max-w-7xl px-6 relative z-10 text-center">
            <span className="text-xs sm:text-sm font-bold uppercase tracking-wider text-red-500 mb-2 block">
              VisualGifts — Welcome Kits
            </span>
            <h1 className="text-4xl font-extrabold text-white mb-4 tracking-tight">
              Kits de Onboarding Corporativos
            </h1>
            <p className="text-lg text-zinc-300 font-normal max-w-2xl mx-auto">
              Garanta uma recepção marcante aos novos colaboradores ou clientes com kits de boas-vindas personalizados com a sua identidade de marca.
            </p>
            <div className="mt-8">
              <button
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-10 items-start">
              ...
              <div className="md:col-span-7 space-y-6">
                ...
                <h2 className="text-3xl font-extrabold text-zinc-900 dark:text-zinc-100 tracking-tight">
                  Kits com identidade e elegância para acolher
                </h2>
                <p className="text-zinc-600 dark:text-zinc-400 text-base leading-relaxed">
                  Um bom acolhimento melhora a retenção de talento e aproxima a sua equipa da visão corporativa. Criamos pacotes que reúnem cadernos de alta qualidade, canetas gravadas a laser, garrafas térmicas personalizadas e polos bordados em caixas ou mochilas premium prontas a entregar.
                </p>
              </div>
              ...
              <div className="md:col-span-5 bg-white dark:bg-zinc-900 border border-zinc-200/80 dark:border-white/10 p-8 rounded-lg">
                <h4 className="font-bold text-zinc-800 dark:text-zinc-200 mb-4 text-sm tracking-wide uppercase border-b border-zinc-100 dark:border-white/10 pb-2">
                  Artigos Comuns em Kits:
                </h4>
                <ul className="space-y-3">
                  {[
                    'Agendas e cadernos Moleskine com capa personalizada',
                    'Garrafas ou canecas térmicas com gravação a laser',
                    'Mochilas para portátil ou sacos ecológicos (tote bags)',
                    'Canetas de escrita fina gravadas com a sua marca',
                    'Pen drives e adaptadores eletrónicos personalizados'
                  ].map((item, idx) => (
        ...
        <div className="py-20">
          <div className="container mx-auto max-w-7xl px-6 text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-8">
              {[
                { step: '1', title: 'Montagem do Kit', desc: 'Escolhe os artigos que constituem o kit de acordo com o orçamento definido por kit.' },
                { step: '2', title: 'Amostra & Layout', desc: 'Desenhamos a personalização de cada item e da caixa para aprovação final em maquete 3D.' },
                { step: '3', title: 'Montagem & Entrega', desc: 'Reunimos e embalamos todos os produtos nas caixas, prontas para entrega direta no seu escritório.' }
              ].map(({ step, title, desc }) => (
        ...
        <div className="py-20">
          <div className="container mx-auto max-w-7xl px-6">
            <div className="bg-red-600 dark:bg-red-700 text-white py-16 rounded-lg text-center space-y-6 shadow-xl shadow-red-600/10 relative overflow-hidden">
              <h2 className="text-3xl font-extrabold">Pretende criar kits de boas-vindas marcantes?</h2>
