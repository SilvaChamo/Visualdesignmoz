...
export function Navbar() {
  ...
  const allSearchableItems = [
    ...
    // Conta
    { href: '/login', icon: User, title: 'Login', desc: 'Aceder à sua conta', bg: 'bg-slate-50', text: 'text-slate-600', tags: 'entrar aceder conta', requiresLogin: false },
      ...
      >
        <div className="max-w-7xl mx-auto w-full px-4 flex justify-between items-center h-full">
          ...
          <div className="flex items-center gap-5">
            ...
            <Link href="/login" className="text-slate-300 hover:text-red-500 transition-colors ml-2 relative group">
