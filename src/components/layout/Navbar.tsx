...
export function Navbar() {
  ...
  const quickAccessItems = [
    { href: '/cliente/domains', icon: Globe, title: 'Gestor de Domínios', desc: 'Gerir os seus domínios', bg: 'bg-teal-50', text: 'text-teal-600', tags: 'domínios gerir', requiresLogin: false },
    ...
    { href: '/cliente/domains', icon: Shield, title: 'DNS Avançado', desc: 'Registos e Zonas', bg: 'bg-purple-50', text: 'text-purple-600', tags: 'dns registos zonas', requiresLogin: false },
    { href: '/notificacoes', icon: CreditCard, title: 'Facturas e Pagamentos', desc: 'Histórico e Pendentes', bg: 'bg-orange-50', text: 'text-orange-600', tags: 'facturas pagamentos', requiresLogin: false },
  ]
  ...
  const allSearchableItems = [
    ...
    { href: '/web', icon: Monitor, title: 'Web Design', desc: 'Criação de sites e lojas online profissionais', bg: 'bg-cyan-50', text: 'text-cyan-600', tags: 'site website loja online ecommerce desenvolvimento serviços', requiresLogin: false },
    ...
    { href: '/producoes/fotografia', icon: Camera, title: 'Fotografia', desc: 'Fotografia profissional e edição', bg: 'bg-amber-50', text: 'text-amber-600', tags: 'fotos sessão fotográfica produto serviços', requiresLogin: false },
    { href: '/producoes', icon: Film, title: 'Vídeo e Produção', desc: 'Produção audiovisual e edição de vídeo', bg: 'bg-red-50', text: 'text-red-600', tags: 'vídeo filmagem edição produção audiovisual serviços', requiresLogin: false },

    // Serviços - Marketing
    { href: '/web', icon: Megaphone, title: 'Marketing Digital', desc: 'Estratégias de marketing online', bg: 'bg-violet-50', text: 'text-violet-600', tags: 'marketing digital google ads facebook campanha publicidade serviços', requiresLogin: false },
    { href: '/web', icon: Globe, title: 'Redes Sociais', desc: 'Gestão de redes sociais', bg: 'bg-blue-50', text: 'text-blue-600', tags: 'instagram facebook tiktok social media serviços', requiresLogin: false },
    ...
    { href: '/eventos/feiras', icon: Rocket, title: 'Feiras e Eventos', desc: 'Stands, materiais e cobertura de eventos', bg: 'bg-amber-50', text: 'text-amber-600', tags: 'evento feira stand exposição conferência serviços', requiresLogin: false },
    ...
    // Conta
    { href: PANEL_LOGIN_HREF, icon: User, title: 'Login', desc: 'Aceder à sua conta', bg: 'bg-slate-50', text: 'text-slate-600', tags: 'entrar aceder conta', requiresLogin: false },

    // Área do Cliente (requer login)
    { href: '/cliente', icon: Lock, title: 'Painel do Cliente', desc: 'Gerir a sua conta e serviços', bg: 'bg-slate-100', text: 'text-slate-700', tags: 'painel dashboard conta cliente', requiresLogin: true },
    { href: '/cliente/domains', icon: Lock, title: 'Meus Domínios', desc: 'Gerir os seus domínios registados', bg: 'bg-teal-50', text: 'text-teal-700', tags: 'domínios meus gerir dns', requiresLogin: true },
      ...
      >
        <div className="max-w-7xl mx-auto w-full px-4 flex justify-between items-center h-full">
          ...
          <div className="flex items-center gap-5">
            ...
            {/* Apenas menus de utilidade mantidos aqui */}
          ...
          <div className="flex items-center gap-5">
            ...
            {/* Painel/Login/Sair já ficam só na barra branca abaixo (Header) — evita duplicação. */}
