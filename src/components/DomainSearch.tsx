  ...
  const renderSearchRow = () => (
    <div className={`flex w-full flex-col gap-2 sm:flex-row ${searchContainerClassName}`}>
      ...
      <button
        ...
        className={`flex w-full shrink-0 items-center justify-center gap-2 ${searchRound} bg-red-600 px-8 py-2 font-bold text-white shadow-md transition-colors hover:bg-red-700 sm:w-auto ${
