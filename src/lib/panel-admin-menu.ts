...
export const NEW_MENU_ITEM_DEFS: PanelMenuItemDef[] = [
  ...
  },
  {
    ...
    subItems: [
      ...
      { id: 'audit-form-create', label: '[Audit] Criar Conta' },
      { id: 'audit-form-edit', label: '[Audit] Editar Conta' },
      { id: 'audit-form-password', label: '[Audit] Modal Senha' },
      { id: 'audit-form-message', label: '[Audit] Modal Mensagem' },
      { id: 'audit-form-inline', label: '[Audit] Provision Inline' },
      { id: 'audit-form-reseller', label: '[Audit] Pacote Revenda' },
    ],
  },
  {
    id: 'nov-email',
...
export const NEW_SECTION_TO_PARENT: Record<string, string> = {
  ...
  'audit-form-create': 'nov-hospedagem',
  'audit-form-edit': 'nov-hospedagem',
  'audit-form-password': 'nov-hospedagem',
  'audit-form-message': 'nov-hospedagem',
  'audit-form-inline': 'nov-hospedagem',
  'audit-form-reseller': 'nov-hospedagem',
