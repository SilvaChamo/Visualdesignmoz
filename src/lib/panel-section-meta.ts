...
const SECTION_TITLES: Record<string, string> = {
  ...
  clientes: 'Contas clientes',
  'utilizadores-revendedores': 'Revendedores',
  'utilizadores-visitantes': 'Visitantes',
  'utilizadores-gestao': 'Gestão',
  'hospedagem-contas': 'Contas',
  'provision-client': 'Criar uma nova conta',
  'provision-reseller': 'Criar revenda',
  'provision-admin': 'Novo administrador',
  'hospedagem-meus': 'Meus utilizadores',
  'hospedagem-mover-revenda': 'Mover utilizadores entre revendas',
  'hospedagem-pendentes': 'Pendentes',
  'hospedagem-templates-mensagem': 'Modelos de mensagem',
  'hospedagem-alterar-senhas': 'Alterar senhas',
...
const SECTION_DESCRIPTIONS: Record<string, string> = {
  ...
  clientes: 'Contas de clientes com acesso ao painel',
  'utilizadores-revendedores': 'Contas de revendedores no painel',
  'utilizadores-visitantes': 'Contas de visitantes com acesso limitado',
  'utilizadores-gestao': 'Contas de gestão com permissões intermédias',
  ...
  'provision-client': 'Criar nova conta de hospedagem no servidor',
  'provision-reseller': 'Nova conta de revenda no servidor',
  'provision-admin': 'Criar acesso de administrador ao painel',
  'hospedagem-meus': 'Contas directamente associadas ao revendedor principal',
  'hospedagem-mover-revenda': 'Transferir contas entre revendedores',
  'hospedagem-pendentes': 'Compras de hospedagem pagas sem domínio associado — concluir manualmente',
  'hospedagem-templates-mensagem': 'Modelos para mensagens às contas',
  'hospedagem-alterar-senhas': 'Alterar passwords de contas de hospedagem',
  'hospedagem-administradores': 'Administradores com acesso ao painel',
  ...
  'nextjs-sites': 'Sites Next.js registados, estado e consumo de CPU',
