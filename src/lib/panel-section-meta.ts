...
const SECTION_DESCRIPTIONS: Record<string, string> = {
  ...
  'cp-wp-list': 'Acesso ao wp-admin de cada site',
  'cp-wp-plugins': 'Activar e desactivar plugins WordPress',
  ...
  'wordpress-install': 'Instalação WordPress no servidor',
  ...
  'wp-update': 'Actualizar plugins WordPress por domínio',
