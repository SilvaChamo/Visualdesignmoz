...
ALTER TABLE panel_users ADD COLUMN IF NOT EXISTS disk_used_mb INTEGER DEFAULT 0;
ALTER TABLE panel_users ADD COLUMN IF NOT EXISTS bandwidth_used_mb INTEGER DEFAULT 0;
