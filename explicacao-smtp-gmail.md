...
- Seus emails corporativos continuam sendo `@visualdesignmoz.com`
...
- **Recebe cartas**: `admin@visualdesignmoz.com`
...
- **Não muda seu endereço**: Remetente continua `admin@visualdesignmoz.com`
...
### **O que muda:**
- **Remetente**: Continua `admin@visualdesignmoz.com` 
...
- Seu email continua: `admin@visualdesignmoz.com`
- Webmail continua no seu servidor
