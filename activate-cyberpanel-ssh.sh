...
# Criar contas
/usr/local/CyberCP/bin/cyberpanel createEmail --domainName visualdesignmoz.com --userName admin --password 'Ad.Vd#2425?*' 2>&1
echo "✓ Conta admin criada/ativada"

/usr/local/CyberCP/bin/cyberpanel createEmail --domainName visualdesignmoz.com --userName suporte --password 'Ad.Vd#2425?*' 2>&1
echo "✓ Conta suporte criada/ativada"

/usr/local/CyberCP/bin/cyberpanel createEmail --domainName visualdesignmoz.com --userName geral --password 'Ad.Vd#2425?*' 2>&1
...
/usr/local/CyberCP/bin/cyberpanel listEmails --domainName visualdesignmoz.com 2>&1 || echo "⚠️ Não foi possível listar emails (possível erro)"
...
SSH_COMMANDS
  ...
  echo "/usr/local/CyberCP/bin/cyberpanel createEmail --domainName visualdesignmoz.com --userName admin --password 'Ad.Vd#2425?*'"
  echo "/usr/local/CyberCP/bin/cyberpanel createEmail --domainName visualdesignmoz.com --userName suporte --password 'Ad.Vd#2425?*'"
  echo "/usr/local/CyberCP/bin/cyberpanel createEmail --domainName visualdesignmoz.com --userName geral --password 'Ad.Vd#2425?*'"
